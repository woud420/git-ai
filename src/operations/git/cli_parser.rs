mod rewrite_args;
pub use rewrite_args::{
    RebaseArgsSummary, explicit_rebase_branch_arg, rebase_has_control_mode,
    stash_requires_target_resolution, stash_subcommand, stash_target_spec, summarize_rebase_args,
};
