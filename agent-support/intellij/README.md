...
<!-- Plugin description -->
**Git AI** tracks code generated by AI coding agents in your JetBrains IDE.

When AI agents like GitHub Copilot make edits, Git AI automatically records
which lines were AI-generated along with the agent and model that wrote them.
On commit, this attribution is persisted through the configured git-ai notes
backend (local SQLite by default), enabling:
