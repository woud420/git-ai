...
use super::test_patch::apply_test_config_patch;
...
pub(crate) fn build_config() -> Config {
    ...
    let config = Config {
        ...
        max_transcript_line_bytes: crate::config::budgets::positive_byte_budget(
            "GIT_AI_MAX_TRANSCRIPT_LINE_BYTES",
            file_cfg.as_ref().and_then(|c| c.max_transcript_line_bytes),
            crate::config::DEFAULT_MAX_TRANSCRIPT_LINE_BYTES,
        ),
        max_transcript_batch_bytes: crate::config::budgets::positive_byte_budget(
            "GIT_AI_MAX_TRANSCRIPT_BATCH_BYTES",
            file_cfg.as_ref().and_then(|c| c.max_transcript_batch_bytes),
            crate::config::DEFAULT_MAX_TRANSCRIPT_BATCH_BYTES,
        ),
        max_transcript_file_bytes: crate::config::budgets::positive_byte_budget(
            "GIT_AI_MAX_TRANSCRIPT_FILE_BYTES",
            file_cfg.as_ref().and_then(|c| c.max_transcript_file_bytes),
            crate::config::DEFAULT_MAX_TRANSCRIPT_FILE_BYTES,
        ),
        max_metrics_flush_chunk_bytes: crate::config::budgets::positive_byte_budget(
            "GIT_AI_MAX_METRICS_FLUSH_CHUNK_BYTES",
            file_cfg
                .as_ref()
                .and_then(|c| c.max_metrics_flush_chunk_bytes),
            crate::config::DEFAULT_MAX_METRICS_FLUSH_CHUNK_BYTES,
        ),
