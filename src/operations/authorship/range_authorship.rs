...
pub fn should_ignore_file(path: &str, ignore_patterns: &[String]) -> bool {
    crate::operations::authorship::ignore::should_ignore_file(path, ignore_patterns)
}
...
fn calculate_range_stats_direct(
    ...
    // Step 3: Resolve known-human acceptance from the range's attestations so
    // human additions are not misreported as unknown.
    ...
    // Step 4: Calculate stats from the authorship log
...
pub fn print_range_authorship_stats(stats: &RangeAuthorshipStats) {
    ...
    use crate::operations::authorship::stats::write_stats_to_terminal;
