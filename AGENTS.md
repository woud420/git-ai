...
When adding or changing checkpoint or attribution tests, read
[checkpoint test patterns](docs/operations/checkpoint-test-patterns.md) for the
standard TestRepo example and explicit checkpoint-ordering walkthrough.
