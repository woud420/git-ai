...
define_command_policy! {
    ...
    "fetch-pack" => POLICY_BUILTIN | POLICY_MAY_MUTATE | POLICY_FAMILY_SEQUENCER | POLICY_TRANSPORT,
    ...
    "restore" => POLICY_BUILTIN | POLICY_MAY_MUTATE | POLICY_FAMILY_SEQUENCER,
    ...
    "rm" => POLICY_BUILTIN,
    "send-pack" => POLICY_BUILTIN | POLICY_MAY_MUTATE | POLICY_FAMILY_SEQUENCER | POLICY_TRANSPORT,
