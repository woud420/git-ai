...
use crate::{
    model::working_log::CheckpointKind,
    operations::commands::checkpoint_agent::orchestrator::CheckpointRequest,
    operations::daemon::checkpoint::PreparedPathRole,
};
#[cfg(not(windows))]
...
type CommitFileTimestampSnapshotHandle = tokio::task::JoinHandle<
...
pub struct ActorDaemonCoordinator {
    backend: Arc<crate::operations::daemon::git_backend::SystemGitBackend>,
    coordinator: Arc<
    ...
    bash_sessions: Mutex<crate::operations::daemon::bash_sessions::BashSessionState>,
    ...
    stream_worker: Option<crate::operations::daemon::stream_worker::StreamWorkerHandle>,
...
mod tests {
    ...
    fn sample_checkpoint_request() -> ControlRequest {
        use crate::operations::commands::checkpoint_agent::orchestrator::{
            BaseCommit, CheckpointFile,
        };
